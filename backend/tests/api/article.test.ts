...
describe('Article Schema', () => {
    ...
    describe('Optional Fields', () => {
        ...
        it('should have excerpt as optional', () => {
            expect(articleSchema.attributes.excerpt.required).toBeUndefined();
            expect(articleSchema.attributes.excerpt.maxLength).toBe(500);
        });

        it('should have publishDate as optional', () => {
            expect(articleSchema.attributes.publishDate.required).toBeUndefined();
            expect(articleSchema.attributes.publishDate.type).toBe('datetime');
        });

        it('should have readTime as optional with defaults', () => {
            expect(articleSchema.attributes.readTime.required).toBeUndefined();
        ...
        it('should have isFeatured as optional with default false', () => {
            expect(articleSchema.attributes.isFeatured.required).toBeUndefined();
            expect(articleSchema.attributes.isFeatured.default).toBe(false);
        });

        it('should have articleStatus as optional with default Draft', () => {
            expect(articleSchema.attributes.articleStatus.required).toBeUndefined();
        ...
        it('should have featuredImage as optional media', () => {
            expect(articleSchema.attributes.featuredImage.required).toBeUndefined();
    ...
    describe('Relations', () => {
        ...
        it('should have pillar relation', () => {
            expect(articleSchema.attributes.pillar.type).toBe('relation');
            expect(articleSchema.attributes.pillar.relation).toBe('manyToOne');
            expect(articleSchema.attributes.pillar.target).toBe('api::pillar.pillar');
        });
