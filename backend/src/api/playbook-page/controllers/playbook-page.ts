...
const PLAYBOOK_PAGE_POPULATE = {
    tenant: { fields: ['name', 'slug'] },
} as const;

// @ts-ignore
export default factories.createCoreController('api::playbook-page.playbook-page' as any, () => ({
    ...
    async find(ctx: any) {
        ...
        ctx.query.populate = PLAYBOOK_PAGE_POPULATE;
